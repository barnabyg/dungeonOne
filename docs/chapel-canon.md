...
| A skeleton guardian blocks access beyond the crypt entrance. | Direct observation | Enter the crypt. | The guardian fight is playable; defeating it records access for later crypt evidence, but offers no ledger, rescue, or completion action. |
